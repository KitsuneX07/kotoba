...
macro_rules! register_providers {
    ($(($module:ident, $name:literal, $provider:ident, $variant:ident),)+) => {
        ...
        /// Builds a [`crate::provider::DynProvider`] from the provided [`crate::config::ModelConfig`].
        ///
        ...
        /// # Returns
        ///
        /// A trait object wrapped in `Arc` that implements [`crate::provider::LLMProvider`].
        ///
        /// # Errors
        ///
